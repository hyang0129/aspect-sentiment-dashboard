...
root = BeautifulSoup(open(r'C:\Users\HongM\PycharmProjects\aspect-sentiment-dashboard\text_data\semeval-2014-restaurants-train.xml'))
...
dump(examples, '../text_data/semeval-2014-restaurants-train.gz')